...
import 'package:boilerplate_flutter/features/auth/presentation/pages/signup_page.dart';
import 'package:boilerplate_flutter/features/auth/presentation/widgets/auth_field.dart';
        ...
        child: BlocConsumer<AuthBloc, AuthState>(
          listener: (context, state) {
            if (state is AuthFailure) {
              showScnackBar(context, state.message);
            }
          },
